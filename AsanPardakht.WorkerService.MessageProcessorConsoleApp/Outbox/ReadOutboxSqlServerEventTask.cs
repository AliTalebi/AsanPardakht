...
namespace AsanPardakht.WorkerService.MessageProcessorConsoleApp.Outbox
{
	public sealed class ReadOutboxSqlServerEventTask : ReadOutboxBackgroundTask
	{
		...
		public ReadOutboxSqlServerEventTask(ILogger<ReadOutboxSqlServerEventTask> logger, DbContextOptions<ProcessDataDbContext> processDataDbContextOptions, DbContextOptions<OutBoxEventDbContext> outBoxEventDbContextOptions)
			: base(logger)
		{

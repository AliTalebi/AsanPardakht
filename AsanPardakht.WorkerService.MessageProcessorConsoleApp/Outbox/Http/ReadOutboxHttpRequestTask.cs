...
namespace AsanPardakht.WorkerService.MessageProcessorConsoleApp.Outbox.Http
{
    public sealed class ReadOutboxHttpRequestTask : ReadOutboxBackgroundTask
    {
        ...
        public ReadOutboxHttpRequestTask(IHttpClientFactory httpClientFactory, IOptionsMonitor<ApiOptions> optionsMonitorApi, DbContextOptions<ProcessDataDbContext> processDataDbContextOptions)
        {
